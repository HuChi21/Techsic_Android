...
public class ThemSanPhamActivity extends AppCompatActivity implements View.OnClickListener {
    private EditText edtTensp,edtThuonghieu,edtGia,edtHinhanh,edtPhanloai,edtThongso,edtMota,edtSoluong,edtLoaisp;
    ...
    private void getWidget() {
        ...
        edtLoaisp = (EditText) findViewById(R.id.loaisp);
    ...
    private void actionToolbar() {
        ...
        toolbar.setTitle("Thêm sản phẩm "+ getIntent().getStringExtra("loaisp"));
    ...
    private void actionAdd() {
        ...
        String soluongco = edtSoluong.getText().toString().trim();
        ...
        if(soluongco.isEmpty()) {
            edtSoluong.setError("Nhập số lượng sản phẩm!");
            edtSoluong.requestFocus();
            return;
        }
        if(Integer.parseInt(soluongco)>100) {
            edtSoluong.setError("Số lượng sản phẩm nhỏ hơn 100!");
            edtSoluong.requestFocus();
            return;
        }
        //setPhanloai
        ...
        try {
            compositeDisposable.add(apiconfig.themSanpham(tensp,thuonghieu,gia,hinhanh,thongso,mota,idloaisp,soluongco,phanloaiJson)
