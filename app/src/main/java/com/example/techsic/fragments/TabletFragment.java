...
public class TabletFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //getWidget
        tabletRecyclerView = (RecyclerView)  view.findViewById(R.id.dienthoaiRecyclerView);
    ...
    private void actionLoadMore() {
        tabletRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
                        ...
                        sanPhamModel -> {
                            if(sanPhamModel.isSuccess()){
                                if (sanphamAdapter ==null){
                                    ...
                                    tabletRecyclerView.setAdapter(sanphamAdapter);
                                }
                                else{
