...
public class TintucTheoloaiAdapter extends RecyclerView.Adapter<TintucTheoloaiAdapter.MyViewHolder> {
    Context context;
    List<TinTuc> list;

    public TintucTheoloaiAdapter(Context context, List<TinTuc> list ) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_tintuctheoloai,parent,false);
