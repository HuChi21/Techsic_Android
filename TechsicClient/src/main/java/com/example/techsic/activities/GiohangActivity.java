...
public class GiohangActivity extends AppCompatActivity {
        ...
        if(tongtt== 0){
            ...
            btnBuy.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(getApplicationContext(), "Chọn sản phẩm cần mua", Toast.LENGTH_SHORT).show();
                }
            });
        }
        txtTongthanhtoan.addTextChangedListener(new TextWatcher() {
            @Override
    ...
    private void actionGioHang() {
        ...
        toolbarGioHang.setNavigationIcon(R.drawable.baseline_arrow_back_white);
