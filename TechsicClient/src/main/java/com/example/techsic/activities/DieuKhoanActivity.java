    ...
    private void getWidget() {
        ...
        btnAgree.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(DieuKhoanActivity.this, "Cảm ơn bạn đã sử dụng ứng dụng Techsic", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
        ...
        private void actionToolBar() {
            ...
            toolbar.setNavigationIcon(R.drawable.baseline_copyright_24);
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    switch (item.getItemId()){
                        ...
                        case R.id.menuDangxuat:
                            AlertDialog.Builder builder = new AlertDialog.Builder(DieuKhoanActivity.this);
