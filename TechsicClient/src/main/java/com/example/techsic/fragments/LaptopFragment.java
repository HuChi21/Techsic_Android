...
public class LaptopFragment extends Fragment {
    ...
    private void getDienThoai(int page, String sapxep) {
        compositeDisposable.add(apibanhang.getSPtheoloai(page, idloaisp, sapxep)
    ...
    private void getDienthoaiSapxep(String sapxep,int isbanchay) {
        compositeDisposable.add(apibanhang.locSP( idloaisp,sapxep)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(
                        sanPhamModel -> {
